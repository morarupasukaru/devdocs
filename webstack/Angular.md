...
* [View queries](https://angular.dev/guide/components/queries#view-queries) and [Content queries](https://angular.dev/guide/components/queries#content-queries) to retrieve elements (component, DOM element, directive, etc.) from template(view) as signal with [viewChild](https://angular.dev/api/core/viewChild), [viewChildren](https://angular.dev/api/core/viewChildren#),
