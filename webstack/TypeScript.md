...
[TypeScript](https://www.typescriptlang.org/) is based on [JavaScript](../minor-topics/JavaScript.md) language and features and add 
...
* [JavaScript's features](../minor-topics/JavaScript.md) are normally also [supported by TypeScript](https://compat-table.github.io/compat-table/)
...
* other nice language features
  ...
  * [decorators](https://devblogs.microsoft.com/typescript/announcing-typescript-5-0/#decorators) to annotate a class/method/property/etc. to add functionality dynamically (like annotations in Java)
    (see also [legacy decorators](https://www.typescriptlang.org/docs/handbook/decorators.html)) 
